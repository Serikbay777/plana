...
# Min N: 3.6 м — позволяет asymmetric работать на типичных МКД глубинах
# 14 м с setback 0.5+0.5 (inner_d=13, usable=9.2). N=3.6 м это узкая
# студия ~18 м² — формально на границе минимальной жилой комнаты СП 54
# п. 5.11, но в asymmetric N это всегда студии/1к.
_ASYM_N_MIN = 3.6
_ASYM_N_MAX = 6.0
_ASYM_S_MIN = 5.4
