...
class MarketingInputs:
    ...
    # Типология этажа для multi_family. По умолчанию симметричная секционка.
    #   "symmetric"        — двухсторонний коридор с равными рядами по обе стороны
    #   "t_shape"          — 2 крупных квартиры наверху + 3 стандартных внизу,
    #                        узкое вертикальное ядро (лифт + лестница раздельно)
    #                        комфорт+/бизнес-класс
    #   "asymmetric_depth" — юг глубже севера (ratio 1.5): крупные форматы
    #                        2к/3к/4к на юге, компактные studio/1к на севере.
    #                        Мокрые зоны спина-к-спине у коридора (общие стояки).
    #                        Референсы: ПИК-1, ПИК-2, Самолёт, Highvill Park,
    #                        BI Family Nest, Bazis Алмалы.
    #   "double_core"      — длинная секция (>42 м) с двумя ядрами на 0.22L
    #                        и 0.78L. Применяется когда одного центрального ядра
    #                        не хватает по пожарным нормам (СП 1.13130 табл. 3:
    #                        ≤40 м между лестницами). Референсы: ПИК Саларьево/
    #                        Бунинские луга, Самолёт Прокшино/Алхимово,
    #                        ФСК «Архитектор», Bazis NEOPARK, Highvill Park.
    #   "tower"            — башенная типология «квадрат 2×2»: 4 угловые
    #                        квартиры вокруг центрального ядра 7.5×7.5,
    #                        каждая с окнами на 2 фасада. Подходит для премиум/
    #                        бизнес-башен 18–30+ этажей на стеснённых участках.
    #                        Референсы: Esentai (Алматы), Highvill F (Астана),
    #                        ORDA Tower, Mercury City Tower, Capital Towers,
    #                        серия КОПЭ-Башня.
    #   "core_shifted"     — ядро смещено на 0.30 от центра. На длинной стороне
    #                        крупные (3к/4к/пентхаус), на короткой мелкие (1к/2к).
    #                        Авторская премиум-типология. Референсы: Меганом,
    #                        Скуратов, Highvill, BAZIS PRIMAVERA, ФСК «Архитектор».
    #   "corner_apt"       — угловая секция здания: 2 фасада S+W. SW квартира
    #                        угловая (3к/4к с 2 фасадами), остальные 3 — обычные.
    #                        v1: прямоугольный outline; L-форма с Г-коридором —
    #                        future. Референсы: Highvill блоки C/F/G, ЖК Потапово,
